...
namespace Catalog.Configuration.Options;
...
public class RateLimitOptions
{
    ...
    public static int ReplenishmentPeriod => AppConfiguration.GetValue<int>(section, ConfigurationResource.CONFIG_RATE_LIMIT_REPLENISHMENT_PERIOD);
}
